...
import { MdHistory, MdOutlineWatchLater, MdSubscriptions, MdVideoLibrary } from "react-icons/md";
...
const Sidebar = () => {
  ...
  const SideBtn = ({ icon, btnName }) => {
    return (
      <button className="flex items-center p-2 w-full my-2 justify-start hover:bg-gray-200 rounded-lg">
